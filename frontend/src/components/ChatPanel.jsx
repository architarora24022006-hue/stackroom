...
function ScoreStamp({ score }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <div style={{
        width: 46, height: 46, borderRadius: '50%', border: '2px solid var(--color-stamp)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        color: 'var(--color-stamp)', fontFamily: 'var(--font-mono)', fontSize: 12, fontWeight: 500,
        flexShrink: 0, transform: 'rotate(-6deg)',
      }}>
        {pct}%
      </div>
    </div>
